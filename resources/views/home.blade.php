...
@section('title', 'Finish Line')

@section('content')
    <aside id="colorlib-hero">
        <div class="flexslider">
            <ul class="slides">
                <li style="background-image: url({{ asset('images/giay1.jpeg') }});">
    ...
    <div class="colorlib-product" style="padding-bottom: 20px;">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6 text-center">
                    <div class="featured">
                        <a href="#" class="featured-img" style="background-image: url({{ asset('images/men.jpg') }});"></a>
                        <div class="desc">
                ...
                <div class="col-sm-6 text-center">
                    <div class="featured">
                        <a href="#" class="featured-img" style="background-image: url({{ asset('images/women.jpg') }});"></a>
                        <div class="desc">
    ...
    @include('frontend.components.new-arrivals')
