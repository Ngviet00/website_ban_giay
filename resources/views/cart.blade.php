            ...
            <div class="row row-pb-lg">
                <div class="col-md-12">
                    ...
                    <div class="product-cart d-flex">
                        <div class="one-forth">
                            <div class="product-img" style="background-image: url({{ asset('images/item-6.jpg') }});">
                            </div>
                    ...
                    <div class="product-cart d-flex">
                        <div class="one-forth">
                            <div class="product-img" style="background-image: url({{ asset('images/item-7.jpg') }});">
                            </div>
                            <div class="display-tc">
                                <h3>Product Name</h3>
                            </div>
                    ...
                    <div class="product-cart d-flex">
                        <div class="one-forth">
                            <div class="product-img" style="background-image: url({{ asset('images/item-8.jpg') }});">
                            </div>
                            <div class="display-tc">
                                <h3>Product Name</h3>
                            </div>
